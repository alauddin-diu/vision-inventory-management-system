...
function activatePanel(label, panel_name, options={}) {
    ...
    localStorage.setItem(`Vision_IMS-selected-panel-${label}`, panel_name);
...
function enableSidebar(label, options={}) {
    ...
    var selected_panel = $.urlParam('display') || localStorage.getItem(`Vision_IMS-selected-panel-${label}`) || options.default;
    ...
    if (options.hide_toggle) {
        ...
        $('#sidebar-toggle').click(function() {
            ...
            var state = localStorage.getItem(`Vision_IMS-menu-state-${label}`) || 'expanded';
    ...
    Vision_IMSGet(
        ...
        filters,
        {
            success: function(data) {
                ...
                // Data are returned from the Vision_IMS server as a flattened list;
...
function setSidebarState(label, state) {
    ...
    localStorage.setItem(`Vision_IMS-menu-state-${label}`, state);
}
