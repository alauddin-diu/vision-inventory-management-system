...
function downloadBomTemplate(options={}) {
    ...
    if (!format) {
        format = Vision_IMSLoad('bom-export-format', 'csv');
    }
    ...
    constructFormBody({}, {
        ...
        onSubmit: function(fields, opts) {
            ...
            Vision_IMSSave('bom-export-format', format);
    ...
    constructFormBody({}, {
        ...
        fields: {
            format: {
                ...
                required: true,
                type: 'choice',
                value: Vision_IMSLoad('bom-export-format', 'csv'),
                choices: exportFormatOptions(),
            },
            cascade: {
                ...
                type: 'boolean',
                value: Vision_IMSLoad('bom-export-cascading', true),
            },
            levels: {
                label: '{% trans "Levels" %}',
        ...
        onSubmit: function(fields, opts) {
            ...
            field_names.forEach(function(fn) {
                ...
                Vision_IMSSave(`bom-export-${fn}`, val);
