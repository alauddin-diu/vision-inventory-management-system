...
/*
 * Perform a GET request to the Vision_IMS server
 */
function Vision_IMSGet(url, filters={}, options={}) {

    if (!url) {
        console.error('Vision_IMSGet called without url');
        return;
    }
 ...
 * contentType: false
 */
function Vision_IMSFormDataUpload(url, data, options={}) {

    if (!url) {
        console.error('Vision_IMSFormDataUpload called without url');
        return;
    }
...
/*
 * Perform a PUT or PATCH request to the Vision_IMS server
 */
function Vision_IMSPut(url, data={}, options={}) {

    if (!url) {
        console.error('Vision_IMSPut called without url');
        return;
    }
 ...
 */
function Vision_IMSDelete(url, options={}) {

    if (!url) {
        console.error('Vision_IMSDelete called without url');
        return;
    }
...
function showApiError(xhr, url) {
    ...
    case 0:
        ...
        message = '{% trans "No response from the Vision_IMS server" %}';
        break;
    // Bad request
    case 400:
