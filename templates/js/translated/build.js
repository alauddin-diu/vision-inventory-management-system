...
function duplicateBuildOrder(build_id, options={}) {
    ...
    Vision_IMSGet(`{% url "api-build-list" %}${build_id}/`, {}, {
    ...
    Vision_IMSGet(
        ...
        {},
        {
            success: function(build) {
                ...
                Vision_IMSGet(`{% url "api-part-list" %}${build.part}/serial-numbers/`, {}, {
                    success: function(data) {
                        if (data.next) {
...
function allocateStockToBuild(build_id, line_items, options={}) {
    ...
    if (output_id) {
        ...
        Vision_IMSGet(`{% url "api-stock-list" %}${output_id}/`, {}, {
            async: false,
...
function loadBuildTable(table, options) {
    ...
    var display_mode = Vision_IMSLoad('build-table-display-mode', 'list');
...
function loadBuildLineTable(table, build_id, options={}) {
    ...
    $(table).Vision_IMSTable(table_options);
