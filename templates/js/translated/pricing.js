...
function baseCurrency() {
    return global_settings.Vision_IMS_DEFAULT_CURRENCY || 'USD';
}
...
function formatCurrency(value, options={}) {
    ...
    let currency = options.currency || global_settings.Vision_IMS_DEFAULT_CURRENCY || 'USD';
...
function getCurrencyConversionRates(cache=true) {
    ...
    Vision_IMSGet('{% url "api-currency-exchange" %}', {}, {
        async: false,
