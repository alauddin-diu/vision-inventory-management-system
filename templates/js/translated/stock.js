...
function serializeStockItem(pk, options={}) {
    ...
    if (options.part) {
        ...
        Vision_IMSGet(`{% url "api-part-list" %}${options.part}/serial-numbers/`, {}, {
            ...
            onSelect: function(data, field, opts) {
                ...
                if (options.create) {
                    ...
                    if (data.trackable) {
                        ...
                        Vision_IMSGet(`{% url "api-part-list" %}${data.pk}/serial-numbers/`, {}, {
                            success: function(data) {
                                var placeholder = '';
                                if (data.next) {
...
function duplicateStockItem(pk, options) {
    ...
    Vision_IMSGet(`{% url "api-stock-list" %}${pk}/`, {}, {
        success: function(data) {
...
function loadStockLocationTable(table, options) {
    ...
    var tree_view = options.allowTreeView && Vision_IMSLoad('location-tree-view') == 1;
    ...
    table.Vision_IMSTable({
        ...
        onPostBody: function() {
            ...
            if (options.allowTreeView) {
                ...
                tree_view = Vision_IMSLoad('location-tree-view') == 1;
        ...
        buttons: options.allowTreeView ? [
            {
                ...
                event: () => {
                    Vision_IMSSave('location-tree-view', 0);
            ...
            },
            {
                ...
                event: () => {
                    Vision_IMSSave('location-tree-view', 1);
