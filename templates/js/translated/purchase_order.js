...
function duplicatePurchaseOrder(order_id, options={}) {
    ...
    Vision_IMSGet(`{% url "api-po-list" %}${order_id}/`, {}, {
    ...
    var fields = {
        ...
        part: {
            ...
            onEdit: function(value, name, field, opts) {
                ...
                Vision_IMSGet(`{% url "api-supplier-part-list" %}${value}/`,
                    {
                        part_detail: true,
                    },
                    {
...
function loadPurchaseOrderTable(table, options) {
    ...
    var display_mode = Vision_IMSLoad('purchaseorder-table-display-mode', 'list');
    ...
    function setupCallbacks() {
        if (options.allow_edit) {
            ...
            $(table).find('.button-line-duplicate').click(function() {
                ...
                Vision_IMSGet(`{% url "api-po-line-list" %}${pk}/`, {}, {
                    success: function(data) {
