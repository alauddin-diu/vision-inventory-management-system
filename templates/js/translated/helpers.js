...
function setupNotesField(element, url, options={}) {
    ...
    const mde = new EasyMDE({
        ...
        imageUploadFunction: function(imageFile, onSuccess, onError) {
            // Attempt to upload the image to the Vision_IMS server
            var form_data = new FormData();

            form_data.append('image', imageFile);

            Vision_IMSFormDataUpload('{% url "api-notes-image-list" %}', form_data, {
                success: function(response) {
 ...
 * attachClipboard('.clip-btn') in script/Vision_IMS/Vision_IMS.js is altered
 */
