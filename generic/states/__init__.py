...
States can be extended with custom options for each Vision_IMS instance - those options are stored in the database and need to link back to state values.
"""
