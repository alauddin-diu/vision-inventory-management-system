...
class CustomSignupForm(SignupForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['email_required'] = Vision_IMSSetting.get_setting('LOGIN_MAIL_REQUIRED')

        super().__init__(*args, **kwargs)

        # check for two mail fields
        if Vision_IMSSetting.get_setting('LOGIN_SIGNUP_MAIL_TWICE'):
        ...
        if not Vision_IMSSetting.get_setting('LOGIN_SIGNUP_PWD_TWICE'):
...
def registration_enabled():
    ...
    return settings.EMAIL_HOST and (Vision_IMSSetting.get_setting('LOGIN_ENABLE_REG') or Vision_IMSSetting.get_setting('LOGIN_ENABLE_SSO_REG'))
...
class RegistratonMixin:
    ...
    def clean_email(self, email):
        ...
        mail_restriction = Vision_IMSSetting.get_setting('LOGIN_SIGNUP_MAIL_RESTRICTION', None)
    ...
    def save_user(self, request, user, form, commit=True):
        ...
        # Check if a default group is set in settings
        start_group = Vision_IMSSetting.get_setting('SIGNUP_GROUP')
        if start_group:
            try:
...
class CustomSocialAccountAdapter(CustomUrlMixin, RegistratonMixin, DefaultSocialAccountAdapter):
    ...
    def is_auto_signup_allowed(self, request, sociallogin):
        ...
        if Vision_IMSSetting.get_setting('LOGIN_SIGNUP_SSO_AUTO', True):
