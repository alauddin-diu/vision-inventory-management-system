"""Serializers used in various Vision_IMS apps."""
...
from Vision_IMS.fields import Vision_IMSRestURLField, Vision_IMSURLField
from Vision_IMS.helpers_model import download_image_from_url


class Vision_IMSMoneySerializer(MoneyField):
...
class Vision_IMSCurrencySerializer(serializers.ChoiceField):
...
class Vision_IMSModelSerializer(serializers.ModelSerializer):
    """Inherits the standard Django ModelSerializer class, but also ensures that the underlying model class data are checked on validation."""

    # Switch out URLField mapping
    serializer_field_mapping = {
        **serializers.ModelSerializer.serializer_field_mapping,
        models.URLField: Vision_IMSRestURLField,
        Vision_IMSURLField: Vision_IMSRestURLField,
    }
...
class Vision_IMSTaggitSerializer(TaggitSerializer):
...
class Vision_IMSTagModelSerializer(Vision_IMSTaggitSerializer, Vision_IMSModelSerializer):
    """Combination of Vision_IMSTaggitSerializer and Vision_IMSModelSerializer."""
    pass


class UserSerializer(Vision_IMSModelSerializer):
...
class Vision_IMSAttachmentSerializerField(serializers.FileField):
...
class Vision_IMSAttachmentSerializer(Vision_IMSModelSerializer):
    """Special case of an Vision_IMSModelSerializer, which handles an "attachment" model.
    ...
    attachment = Vision_IMSAttachmentSerializerField(
        required=False,
        allow_null=False,
    )
...
class Vision_IMSImageSerializerField(serializers.ImageField):
...
class Vision_IMSDecimalField(serializers.FloatField):
...
class RemoteImageMixin(metaclass=serializers.SerializerMetaclass):
    ...
    def validate_remote_image(self, url):
        ...
        if not common_models.Vision_IMSSetting.get_setting('Vision_IMS_DOWNLOAD_FROM_URL'):
