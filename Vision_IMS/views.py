...
class Vision_IMSRoleMixin(PermissionRequiredMixin):
...
class AjaxMixin(Vision_IMSRoleMixin):
...
class SetPasswordView(AjaxUpdateView):
    ...
    ajax_template_name = "Vision_IMS/password.html"
...
class IndexView(TemplateView):
    """View for Vision_IMS index page."""

    template_name = 'Vision_IMS/index.html'


class SearchView(TemplateView):
    """View for Vision_IMS search page.

    Displays results of search query
    """

    template_name = 'Vision_IMS/search.html'
...
class SettingsView(TemplateView):
    ...
    template_name = "Vision_IMS/settings/settings.html"

    def get_context_data(self, **kwargs):
        """Add data for template."""
        ctx = super().get_context_data(**kwargs).copy()

        ctx['settings'] = common_models.Vision_IMSSetting.objects.all().order_by('key')

        ctx["base_currency"] = common_settings.currency_code_default()
        ctx["currencies"] = common_settings.currency_codes

        ctx["rates"] = Rate.objects.filter(backend="Vision_IMSExchange")
...
class AboutView(AjaxView):
    """A view for displaying Vision_IMS version information"""

    ajax_template_name = "about.html"
    ajax_form_title = _("About Vision_IMS")


class NotificationsView(TemplateView):
    """View for showing notifications."""

    template_name = "Vision_IMS/notifications/notifications.html"
