...
def health_status(request):
    ...
    if hasattr(request, '_Vision_IMS_health_status'):
        # Do not duplicate efforts
        return {}

    request._Vision_IMS_health_status = True

    status = {
        'django_q_running': Vision_IMS.status.is_worker_running(),
        'email_configured': Vision_IMS.email.is_email_configured(),
    }
    ...
    status['up_to_date'] = Vision_IMS.version.isVision_IMSUpToDate()
...
def status_codes(request):
    ...
    if hasattr(request, '_Vision_IMS_status_codes'):
        # Do not duplicate efforts
        return {}

    request._Vision_IMS_status_codes = True
