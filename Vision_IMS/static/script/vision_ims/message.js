...
function addCachedAlert(message, options={}) {
    ...
    var alerts = sessionStorage.getItem('Vision_IMS-alerts');
    ...
    sessionStorage.setItem('Vision_IMS-alerts', JSON.stringify(alerts));
}
...
function clearCachedAlerts() {
    sessionStorage.removeItem('Vision_IMS-alerts');
}
...
function showCachedAlerts() {
    ...
    var alerts = JSON.parse(sessionStorage.getItem('Vision_IMS-alerts')) || [];
