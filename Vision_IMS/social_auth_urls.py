...
class SocialProvierListView(ListAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        data = {
            'sso_enabled': Vision_IMSSetting.get_setting('LOGIN_ENABLE_SSO'),
            'sso_registration': Vision_IMSSetting.get_setting('LOGIN_ENABLE_SSO_REG'),
            'mfa_required': Vision_IMSSetting.get_setting('LOGIN_ENFORCE_MFA'),
