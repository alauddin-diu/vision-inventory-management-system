...
import users.models
from Vision_IMS.filters import SEARCH_ORDER_FILTER
from Vision_IMS.mixins import ListCreateAPI
from Vision_IMS.permissions import RolePermission
from part.templatetags.vision_ims_extras import plugins_info
from plugin.serializers import MetadataSerializer

from .mixins import RetrieveUpdateAPI
from .status import is_worker_running
from .version import (Vision_IMSApiVersion, Vision_IMSInstanceName,
                      Vision_IMSVersion)
from .views import AjaxView


class InfoView(AjaxView):
    """Simple JSON endpoint for Vision_IMS information.
    ...
    def get(self, request, *args, **kwargs):
        ...
        data = {
            'server': 'Vision_IMS',
            'version': Vision_IMSVersion(),
            'instance': Vision_IMSInstanceName(),
            'apiVersion': Vision_IMSApiVersion(),
...
class APIDownloadMixin:
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = 'Vision_IMS_Stocktake_{date}.{fmt}'.format(
