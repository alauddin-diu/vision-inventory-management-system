"""Custom exchange backend which hooks into the Vision_IMS plugin system to fetch exchange rates from an external API."""
...
class Vision_IMSExchange(SimpleExchangeBackend):
    ...
    def get_rates(self, **kwargs) -> None:
        ...
        slug = Vision_IMSSetting.get_setting('CURRENCY_UPDATE_PLUGIN', '', create=False)
