"""General filters for Vision_IMS."""
...
class Vision_IMSSearchFilter(filters.SearchFilter):
    ...
    def get_search_fields(self, view, request):
        ...
        regex = Vision_IMS.helpers.str2bool(request.query_params.get('search_regex', False))
    ...
    def get_search_terms(self, request):
        ...
        whole = Vision_IMS.helpers.str2bool(request.query_params.get('search_whole', False))
...
class Vision_IMSOrderingFilter(filters.OrderingFilter):
