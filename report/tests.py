...
class ReportTagTest(TestCase):
    ...
    def debug_mode(self, value: bool):
        ...
        Vision_IMSSetting.set_setting('REPORT_DEBUG_MODE', value, change_user=None)
    ...
    def test_logo_image(self):
        ...
        # By default, should return the core Vision_IMS logo
        for b in [True, False]:
            self.debug_mode(b)
            logo = report_tags.logo_image()
            self.assertIn('Vision_IMS.png', logo)
...
class ReportTest(Vision_IMSAPITestCase):
...
class TestReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_test_report.html', 'stock item test report')
    ...
    def test_print(self):
        ...
        Vision_IMSSetting.set_setting('REPORT_ATTACH_TEST_REPORT', True, None)
...
class BuildReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_build_order.html', 'build order template')
    ...
    def test_print(self):
        ...
        inline = Vision_IMSUserSetting.get_setting_object('REPORT_INLINE', cache=False, user=self.user)
        inline.value = True
        inline.save()
...
class BOMReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_bill_of_materials_report.html', 'bill of materials report')
...
class PurchaseOrderReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_po_report.html', 'purchase order report')
...
class SalesOrderReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_so_report.html', 'sales order report')
...
class ReturnOrderReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_return_order_report.html', 'return order report')
...
class StockLocationReportTest(ReportTest):
    ...
    def setUp(self):
        ...
        self.copyReportTemplate('Vision_IMS_slr_report.html', 'stock location report')
