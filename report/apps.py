...
class ReportConfig(AppConfig):
    ...
    def create_default_test_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_test_report.html',
                'name': 'Vision_IMS Test Report',
    ...
    def create_default_bill_of_materials_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_bill_of_materials_report.html',
    ...
    def create_default_build_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_build_order.html',
                'name': 'Vision_IMS Build Order',
    ...
    def create_default_purchase_order_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_po_report.html',
                'name': 'Vision_IMS Purchase Order',
    ...
    def create_default_sales_order_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_so_report.html',
                'name': 'Vision_IMS Sales Order',
    ...
    def create_default_return_order_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_return_order_report.html',
                'name': 'Vision_IMS Return Order',
    ...
    def create_default_stock_location_reports(self):
        ...
        reports = [
            {
                'file': 'Vision_IMS_slr_report.html',
                'name': 'Vision_IMS Stock Location',
