...
from Vision_IMS.helpers_model import get_base_url
from Vision_IMS.models import MetadataMixin
...
class ReportTemplateBase(MetadataMixin, ReportBase):
    ...
    def get_report_size(self):
        ...
        try:
            page_size_default = common.models.Vision_IMSSetting.get_setting('REPORT_DEFAULT_PAGE_SIZE', 'A4')
        except Exception:
