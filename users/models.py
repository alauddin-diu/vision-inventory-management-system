...
class RuleSet(models.Model):
    ...
    There are *many* apps models used within Vision_IMS,
    ...
    RULESET_IGNORE = [
        ...
        'common_colortheme',
        'common_customunit',
        'common_Vision_IMSsetting',
        'common_Vision_IMSusersetting',
...
def update_group_roles(group, debug=False):
    ...
    a) Whenever the Vision_IMS database is launched
...
class Owner(models.Model):
    ...
    Owner can be associated to any Vision_IMS model (part, stock, build, etc.)
