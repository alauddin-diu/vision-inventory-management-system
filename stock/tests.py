...
from Vision_IMS.status_codes import StockHistoryCode
...
class StockTestBase(Vision_IMSTestCase):
...
class StockTest(StockTestBase):
    ...
    def test_serial_numbers(self):
        ...
        Vision_IMSSetting.set_setting('SERIAL_NUMBER_GLOBALLY_UNIQUE', True, self.user)
        ...
        Vision_IMSSetting.set_setting('SERIAL_NUMBER_GLOBALLY_UNIQUE', False, self.user)
    ...
    def test_serials(self):
        ...
        Vision_IMSSetting.set_setting('SERIAL_NUMBER_GLOBALLY_UNIQUE', False, None)
    ...
    def test_location_tree(self):
        ...
        Ref: https://github.com/Vision_IMS/Vision_IMS/issues/2636
        Ref: https://github.com/Vision_IMS/Vision_IMS/issues/2733
        """
