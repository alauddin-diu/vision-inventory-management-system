...
class StockAPITestCase(Vision_IMSAPITestCase):
...
class StockItemListTest(StockAPITestCase):
    ...
    def test_filter_by_expired(self):
        ...
        Vision_IMSSetting.set_setting('STOCK_ENABLE_EXPIRY', True, self.user)
...
class StockTestResultTest(StockAPITestCase):
    ...
    def test_post_bitmap(self):
        ...
        For some (unknown) reason, prior to fix https://github.com/Vision_IMS/Vision_IMS/pull/2018
...
class StockMetadataAPITest(Vision_IMSAPITestCase):
