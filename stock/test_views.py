...
class StockViewTestCase(Vision_IMSTestCase):
...
class StockOwnershipTest(StockViewTestCase):
    ...
    def enable_ownership(self):
        ...
        Vision_IMSSetting.set_setting('STOCK_OWNERSHIP_CONTROL', True, self.user)
        self.assertEqual(True, Vision_IMSSetting.get_setting('STOCK_OWNERSHIP_CONTROL'))
