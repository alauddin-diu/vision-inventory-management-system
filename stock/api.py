...
from Vision_IMS.helpers import (DownloadFile, extract_serial_numbers, isNull,
                               str2bool, str2int)
from Vision_IMS.mixins import (CreateAPI, CustomRetrieveUpdateDestroyAPI,
                              ListAPI, ListCreateAPI, RetrieveAPI,
                              RetrieveUpdateDestroyAPI)
from Vision_IMS.status_codes import StockHistoryCode, StockStatus
...
class StockLocationList(APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_Locations.{export_format}"
...
class StockList(APIDownloadMixin, ListCreateDestroyAPIView):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = 'Vision_IMS_StockItems_{date}.{fmt}'.format(
