...
class StockIndex(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['ownership_enabled'] = common.models.Vision_IMSSetting.get_setting('STOCK_OWNERSHIP_CONTROL')

        return context


class StockLocationDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
...
class StockItemDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        data['ownership_enabled'] = common.models.Vision_IMSSetting.get_setting('STOCK_OWNERSHIP_CONTROL')
