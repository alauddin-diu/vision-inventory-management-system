...
from Vision_IMS.helpers import (DownloadFile, increment_serial_number, isNull,
                               str2bool, str2int)
from Vision_IMS.mixins import (CreateAPI, CustomRetrieveUpdateDestroyAPI,
                              ListAPI, ListCreateAPI, RetrieveAPI,
                              RetrieveUpdateAPI, RetrieveUpdateDestroyAPI,
                              UpdateAPI)
from Vision_IMS.permissions import RolePermission
...
class CategoryList(CategoryMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_Categories.{export_format}"
...
class PartList(PartMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Vision_IMS_Parts.{export_format}"
