    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', Vision_IMS.fields.RoundingDecimalField(decimal_places=5, default=1, help_text='Price break quantity', max_digits=15, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Quantity')),
