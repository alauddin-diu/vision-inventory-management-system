    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overage', models.CharField(blank=True, help_text='Estimated build wastage quantity (absolute or percentage)', max_length=24, validators=[Vision_IMS.validators.validate_overage])),
