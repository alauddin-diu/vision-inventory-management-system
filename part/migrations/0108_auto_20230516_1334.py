...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='units',
            field=models.CharField(blank=True, help_text='Physical units for this parameter', max_length=25, validators=[Vision_IMS.validators.validate_physical_units], verbose_name='Units'),
        ),
    ]
