    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', Vision_IMS.fields.RoundingDecimalField(decimal_places=5, default=1, max_digits=15, validators=[django.core.validators.MinValueValidator(1)])),
                ('cost', Vision_IMS.fields.RoundingDecimalField(decimal_places=5, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
