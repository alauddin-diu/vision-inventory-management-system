...
class ParameterTests(TestCase):
    ...
    def test_param_unit_validation(self):
        ...
        Vision_IMSSetting.set_setting('PART_PARAMETER_ENFORCE_UNITS', False, change_user=None)
        ...
        Vision_IMSSetting.set_setting('PART_PARAMETER_ENFORCE_UNITS', True, change_user=None)
...
class PartParameterTest(Vision_IMSAPITestCase):
