...
class PartResource(Vision_IMSResource):
...
class PartImportResource(Vision_IMSResource):
    """Class for managing Part data import/export."""
...
class PartCategoryResource(Vision_IMSResource):
...
class BomItemResource(Vision_IMSResource):
...
class ParameterResource(Vision_IMSResource):
