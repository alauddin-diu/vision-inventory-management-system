...
class PartPricingTests(Vision_IMSTestCase):
    """Unit tests for part pricing calculations"""
    ...
    def test_internal_pricing(self):
        ...
        common.models.Vision_IMSSetting.set_setting('PART_INTERNAL_PRICE', True, None)
    ...
    def test_stock_item_pricing(self):
        ...
        common.models.Vision_IMSSetting.set_setting('PRICING_USE_STOCK_PRICING', False, None)
        ...
        common.models.Vision_IMSSetting.set_setting('PRICING_USE_STOCK_PRICING', True, None)
    ...
    def test_delete_part_with_stock_items(self):
        ...
        Ref: https://github.com/Vision_IMS/Vision_IMS/issues/4419
