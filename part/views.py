...
from Vision_IMS.helpers import str2bool, str2int
from Vision_IMS.views import AjaxUpdateView, AjaxView, Vision_IMSRoleMixin
...
class PartIndex(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, ListView):
...
class PartDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
...
class BomUpload(Vision_IMSRoleMixin, DetailView):
...
class PartPricing(AjaxView):
    ...
    def get_pricing(self, quantity=1, currency=None):
        ...
        if part.bom_count > 0:
            ...
            use_internal = Vision_IMSSetting.get_setting('PART_BOM_USE_INTERNAL_PRICE', False)
...
class CategoryDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
