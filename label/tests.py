...
from Vision_IMS.helpers import validateFilterString
...
class LabelTest(Vision_IMSAPITestCase):
    ...
    def test_print_part_label(self):
        ...
        Vision_IMSSetting.set_setting('REPORT_ENABLE', True, None)

        # Set the 'debug' setting for the plugin
        plugin = registry.get_plugin('Vision_IMSlabel')
        ...
        self.assertIn("img/Vision_IMS.png", content)
