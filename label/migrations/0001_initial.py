    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filters', models.CharField(blank=True, help_text='Query filters (comma-separated list of key=value pairs', max_length=250, validators=[Vision_IMS.helpers.validateFilterString])),
            ],
            options={
                'abstract': False,
            },
