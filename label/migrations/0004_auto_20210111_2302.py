...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='stockitemlabel',
            name='filters',
            field=models.CharField(blank=True, help_text='Query filters (comma-separated list of key=value pairs', max_length=250, validators=[Vision_IMS.helpers.validateFilterString], verbose_name='Filters'),
        ),
        migrations.AlterField(
            model_name='stockitemlabel',
            name='label',
