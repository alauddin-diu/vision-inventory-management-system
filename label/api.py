...
from plugin.builtin.labels.vision_ims_label import Vision_IMSLabelPlugin
...
class LabelPrintMixin(LabelFilterMixin):
    ...
    def get(self, request, *args, **kwargs):
        ...
        common.models.Vision_IMSUserSetting.set_setting('DEFAULT_' + self.ITEM_KEY.upper() + '_LABEL_TEMPLATE',
    ...
    def get_plugin(self, request):
        ...
        if plugin_key is None:
            ...
            plugin_key = Vision_IMSLabelPlugin.NAME.lower()
