...
from Vision_IMS import unit_test
...
class TestReferencePatternMigration(MigratorTestCase):
    ...
    def prepare(self):
        ...
        Setting = self.old_state.apps.get_model('common', 'Vision_IMSsetting')
    ...
    def test_reference_migration(self):
        ...
        Setting = self.new_state.apps.get_model('common', 'Vision_IMSsetting')
...
class TestBuildLineCreation(MigratorTestCase):
    ...
    Ref: https://github.com/Vision_IMS/Vision_IMS/pull/4855
