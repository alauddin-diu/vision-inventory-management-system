...
from Vision_IMS.api import AttachmentMixin, APIDownloadMixin, ListCreateDestroyAPIView, MetadataView
from generic.states.api import StatusView
from Vision_IMS.helpers import str2bool, isNull, DownloadFile
from Vision_IMS.status_codes import BuildStatus, BuildStatusGroups
from Vision_IMS.mixins import CreateAPI, RetrieveUpdateDestroyAPI, ListCreateAPI
...
from Vision_IMS.filters import SEARCH_ORDER_FILTER_ALIAS
...
class BuildList(APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_BuildOrders.{export_format}"
