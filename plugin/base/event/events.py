...
from Vision_IMS.ready import canAppAccessDatabase, isImportingData
...
def trigger_event(event, *args, **kwargs):
    ...
    if not Vision_IMSSetting.get_setting('ENABLE_PLUGINS_EVENTS', False):
...
def register_event(event, *args, **kwargs):
    ...
    if settings.PLUGIN_TESTING or Vision_IMSSetting.get_setting('ENABLE_PLUGINS_EVENTS'):
