...
from plugin import Vision_IMSPlugin, MixinNotImplementedError, registry
from plugin.base.locate.mixins import LocateMixin
from stock.models import StockItem, StockLocation


class LocatePluginTests(Vision_IMSAPITestCase):
    ...
    def test_mixin_locate(self):
        ...
        class SamplePlugin(LocateMixin, Vision_IMSPlugin):
            pass
