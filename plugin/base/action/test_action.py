...
class ActionMixinTests(TestCase):
    ...
    def setUp(self):
        ...
        """
        class SimplePlugin(ActionMixin, Vision_IMSPlugin):
            pass
        self.plugin = SimplePlugin()

        class TestActionPlugin(ActionMixin, Vision_IMSPlugin):
            """An action plugin."""
            ACTION_NAME = 'abc123'
        ...
        class NameActionPlugin(ActionMixin, Vision_IMSPlugin):
            NAME = 'Aplugin'
...
class APITests(Vision_IMSTestCase):
