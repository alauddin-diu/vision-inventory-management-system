...
from plugin.builtin.barcodes.vision_ims_barcode import \
    Vision_IMSInternalBarcodePlugin
...
class BarcodeScan(APIView):
    ...
    A barcode could follow the internal Vision_IMS barcode format,
...
class BarcodeAssign(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Here we only check against 'Vision_IMS' plugins
        ...
        for model in Vision_IMSInternalBarcodePlugin.get_supported_barcode_models():
...
class BarcodeUnassign(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        supported_models = Vision_IMSInternalBarcodePlugin.get_supported_barcode_models()
