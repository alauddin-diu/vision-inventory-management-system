...
class FilteredEventPluginSampleTests(TestCase):
    ...
    def test_run_event(self):
        ...
        Vision_IMSSetting.set_setting('ENABLE_PLUGINS_EVENTS', True, change_user=None)
        ...
        self.assertIn('DEBUG:Vision_IMS:Event `test.event` triggered in sample plugin', cm[1])
    ...
    def test_ignore_event(self):
        ...
        self.assertNotIn('DEBUG:Vision_IMS:Event `test.some.other.event` triggered in sample plugin', cm[1])
