...
class SampleIntegrationPlugin(AppMixin, SettingsMixin, UrlsMixin, NavigationMixin, Vision_IMSPlugin):
    ...
    SETTINGS = {
        'PO_FUNCTION_ENABLE': {
            'name': _('Enable PO'),
            'description': _('Enable PO functionality in Vision_IMS interface'),
            'default': True,
            'validator': bool,
        },
        'API_KEY': {
