...
class SampleIntegrationPluginTests(Vision_IMSTestCase):
    ...
    def test_view(self):
        ...
        Vision_IMSSetting.set_setting('ENABLE_PLUGINS_URL', False, None)
        ...
        Vision_IMSSetting.set_setting('ENABLE_PLUGINS_URL', True, None)
