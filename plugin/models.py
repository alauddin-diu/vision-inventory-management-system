...
class PluginConfig(Vision_IMS.models.MetadataMixin, models.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Save plugin
        self.plugin: Vision_IMSPlugin = plugin
...
class PluginSetting(common.models.BaseVision_IMSSetting):
    ...
    def get_setting_definition(cls, key, **kwargs):
        """In the BaseVision_IMSSetting class, we have a class attribute named 'SETTINGS', which is a dict object that fully defines all the setting parameters.

        Here, unlike the BaseVision_IMSSetting, we do not know the definitions of all settings
...
class NotificationUserSetting(common.models.BaseVision_IMSSetting):
