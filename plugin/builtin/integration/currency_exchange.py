...
class Vision_IMSCurrencyExchange(APICallMixin, CurrencyExchangeMixin, Vision_IMSPlugin):
    """Default Vision_IMS plugin for currency exchange rates.

    Fetches exchange rate information from frankfurter.app
    """

    NAME = "Vision_IMSCurrencyExchange"
    SLUG = "Vision_IMScurrencyexchange"
    AUTHOR = _('Vision_IMS contributors')
    TITLE = _("Vision_IMS Currency Exchange")
