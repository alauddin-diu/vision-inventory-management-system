...
class PlgMixin:
    ...
    def get_plugin(self):
        ...
        return Vision_IMSCoreNotificationsPlugin


class Vision_IMSCoreNotificationsPlugin(SettingsContentMixin, SettingsMixin, Vision_IMSPlugin):
    """Core notification methods for Vision_IMS."""

    NAME = "Vision_IMSCoreNotificationsPlugin"
    TITLE = _("Vision_IMS Notifications")
    ...
    class EmailNotification(PlgMixin, BulkNotificationMethod):
        ...
        def get_targets(self):
            ...
            for user in self.targets:
                ...
                allows_emails = Vision_IMS.helpers.str2bool(self.usersetting(user))
        ...
        def send_bulk(self):
            ...
            instance_title = common.models.Vision_IMSSetting.get_setting('Vision_IMS_INSTANCE')
            ...
            Vision_IMS.email.send_email(subject, '', targets, html_message=html_message)
