"""Unit tests for Vision_IMSBarcodePlugin."""
...
class TestVision_IMSBarcode(Vision_IMSAPITestCase):
    """Tests for the integrated Vision_IMSBarcode barcode plugin."""
    ...
    def test_assign_to_part(self):
        ...
        self.assertEqual(response.data['plugin'], 'Vision_IMSBarcode')
        self.assertEqual(response.data['part']['pk'], 1)
