...
class SettingsAdmin(ImportExportModelAdmin):
    """Admin settings for Vision_IMSSetting."""
...
class UserSettingsAdmin(ImportExportModelAdmin):
    """Admin settings for Vision_IMSUserSetting."""
...
admin.site.register(common.models.Vision_IMSSetting, SettingsAdmin)
admin.site.register(common.models.Vision_IMSUserSetting, UserSettingsAdmin)
