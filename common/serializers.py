...
from Vision_IMS.helpers import get_objectreference
from Vision_IMS.helpers_model import construct_absolute_url
from Vision_IMS.serializers import (Vision_IMSImageSerializerField,
...
class SettingsSerializer(Vision_IMSModelSerializer):
...
class GlobalSettingsSerializer(SettingsSerializer):
    """Serializer for the Vision_IMSSetting model."""

    class Meta:
        """Meta options for GlobalSettingsSerializer."""

        model = common_models.Vision_IMSSetting
        fields = [
            'pk',
            'key',
            'value',
...
class UserSettingsSerializer(SettingsSerializer):
    """Serializer for the Vision_IMSUserSetting model."""

    class Meta:
        """Meta options for UserSettingsSerializer."""

        model = common_models.Vision_IMSUserSetting
        fields = [
            'pk',
            'key',
            'value',
...
class NotificationMessageSerializer(Vision_IMSModelSerializer):
    """Serializer for the Vision_IMSUserSetting model."""
...
class NewsFeedEntrySerializer(Vision_IMSModelSerializer):
...
class ConfigSerializer(serializers.Serializer):
    """Serializer for the Vision_IMS configuration.
...
class NotesImageSerializer(Vision_IMSModelSerializer):
    ...
    image = Vision_IMSImageSerializerField(required=True)


class ProjectCodeSerializer(Vision_IMSModelSerializer):
...
class CustomUnitSerializer(Vision_IMSModelSerializer):
