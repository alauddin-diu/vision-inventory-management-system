...
from Vision_IMS.models import Vision_IMSNotesMixin
from Vision_IMS.tasks import ScheduledTask, scheduled_task
...
def update_news_feed():
    ...
    try:
        d = feedparser.parse(settings.Vision_IMS_NEWS_URL)
...
def delete_old_notes_images():
    ...
    note_classes = getModelsWithMixin(Vision_IMSNotesMixin)
