...
class MethodStorageClass:
    """Class that works as registry for all available notification methods in Vision_IMS.
    ...
    def collect(self, selected_classes=None):
        ...
        current_method = Vision_IMS.helpers.inheritors(NotificationMethod) - IGNORED_NOTIFICATION_CLS
...
class Vision_IMSNotificationBodies:
    """Default set of notifications for Vision_IMS.
