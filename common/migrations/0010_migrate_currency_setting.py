...
def set_default_currency(apps, schema_editor):
    ...
    base_currency = get_setting('Vision_IMS_BASE_CURRENCY', 'base_currency', 'USD')
    ...
    # write to database
    Vision_IMSSetting.set_setting('Vision_IMS_DEFAULT_CURRENCY', base_currency, None, create=True)
