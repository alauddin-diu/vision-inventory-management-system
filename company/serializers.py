...
from Vision_IMS.serializers import (Vision_IMSAttachmentSerializer,
                                   ...
                                   Vision_IMSImageSerializerField,
                                   Vision_IMSModelSerializer,
                                   Vision_IMSMoneySerializer,
                                   Vision_IMSTagModelSerializer,
                                   RemoteImageMixin)
...
class CompanyBriefSerializer(Vision_IMSModelSerializer):
...
class AddressSerializer(Vision_IMSModelSerializer):
...
class AddressBriefSerializer(Vision_IMSModelSerializer):
...
class CompanySerializer(RemoteImageMixin, Vision_IMSModelSerializer):
    ...
    image = Vision_IMSImageSerializerField(required=False, allow_null=True)

    parts_supplied = serializers.IntegerField(read_only=True)
    parts_manufactured = serializers.IntegerField(read_only=True)
    address_count = serializers.IntegerField(read_only=True)

    currency = Vision_IMSCurrencySerializer(help_text=_('Default currency used for this supplier'), required=True)
...
class CompanyAttachmentSerializer(Vision_IMSAttachmentSerializer):
...
class ContactSerializer(Vision_IMSModelSerializer):
...
class ManufacturerPartSerializer(Vision_IMSTagModelSerializer):
...
class ManufacturerPartAttachmentSerializer(Vision_IMSAttachmentSerializer):
...
class ManufacturerPartParameterSerializer(Vision_IMSModelSerializer):
...
class SupplierPartSerializer(Vision_IMSTagModelSerializer):
...
class SupplierPriceBreakSerializer(Vision_IMSModelSerializer):
