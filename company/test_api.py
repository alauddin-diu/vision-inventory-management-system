...
class CompanyTest(Vision_IMSAPITestCase):
...
class ContactTest(Vision_IMSAPITestCase):
...
class AddressTest(Vision_IMSAPITestCase):
...
class ManufacturerTest(Vision_IMSAPITestCase):
...
class SupplierPartTest(Vision_IMSAPITestCase):
...
class CompanyMetadataAPITest(Vision_IMSAPITestCase):
