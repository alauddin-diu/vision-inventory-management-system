...
class CompanyResource(Vision_IMSResource):
...
class SupplierPartResource(Vision_IMSResource):
...
class ManufacturerPartResource(Vision_IMSResource):
...
class ManufacturerPartParameterResource(Vision_IMSResource):
...
class SupplierPriceBreakResource(Vision_IMSResource):
...
class AddressResource(Vision_IMSResource):
...
class ContactResource(Vision_IMSResource):
