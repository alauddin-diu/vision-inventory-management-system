...
class CompanyIndex(Vision_IMSRoleMixin, ListView):
...
class CompanyDetail(Vision_IMSPluginViewMixin, DetailView):
...
class ManufacturerPartDetail(Vision_IMSPluginViewMixin, DetailView):
...
class SupplierPartDetail(Vision_IMSPluginViewMixin, DetailView):
