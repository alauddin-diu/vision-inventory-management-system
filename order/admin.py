...
from Vision_IMS.admin import Vision_IMSResource
...
class PurchaseOrderResource(ProjectCodeResourceMixin, TotalPriceResourceMixin, Vision_IMSResource):
...
class PurchaseOrderLineItemResource(PriceResourceMixin, Vision_IMSResource):
...
class PurchaseOrderExtraLineResource(PriceResourceMixin, Vision_IMSResource):
...
class SalesOrderResource(ProjectCodeResourceMixin, TotalPriceResourceMixin, Vision_IMSResource):
...
class SalesOrderLineItemResource(PriceResourceMixin, Vision_IMSResource):
    ...
    def dehydrate_sale_price(self, item):
        ...
        Ref: https://github.com/Vision_IMS/Vision_IMS/issues/2207
        """
        if item.sale_price:
...
class SalesOrderExtraLineResource(PriceResourceMixin, Vision_IMSResource):
...
class ReturnOrderResource(ProjectCodeResourceMixin, TotalPriceResourceMixin, Vision_IMSResource):
...
class ReturnOrderLineItemResource(PriceResourceMixin, Vision_IMSResource):
...
class ReturnOrderExtraLineClass(PriceResourceMixin, Vision_IMSResource):
