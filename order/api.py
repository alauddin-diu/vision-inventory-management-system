...
from Vision_IMS.api import (APIDownloadMixin, AttachmentMixin,
                           ListCreateDestroyAPIView, MetadataView)
from Vision_IMS.filters import SEARCH_ORDER_FILTER, SEARCH_ORDER_FILTER_ALIAS
from Vision_IMS.helpers import DownloadFile, str2bool
from Vision_IMS.helpers_model import construct_absolute_url, get_base_url
from Vision_IMS.mixins import (CreateAPI, ListAPI, ListCreateAPI,
...
class PurchaseOrderList(PurchaseOrderMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_PurchaseOrders.{export_format}"
...
class PurchaseOrderLineItemList(PurchaseOrderLineItemMixin, APIDownloadMixin, ListCreateDestroyAPIView):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_PurchaseOrderItems.{export_format}"
...
class PurchaseOrderExtraLineList(GeneralExtraLineList, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Vision_IMS_ExtraPurchaseOrderLines.{export_format}"
...
class SalesOrderList(SalesOrderMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_SalesOrders.{export_format}"
...
class SalesOrderLineItemList(SalesOrderLineItemMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filename = f"Vision_IMS_SalesOrderItems.{export_format}"
...
class SalesOrderExtraLineList(GeneralExtraLineList, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Vision_IMS_extrasalesOrderLines.{export_format}"
...
class ReturnOrderList(ReturnOrderMixin, APIDownloadMixin, ListCreateAPI):
    ...
    def download_queryset(self, queryset, export_format):
        ...
        filedata = dataset.export(export_format)
        filename = f"Vision_IMS_ReturnOrders.{export_format}"
...
class OrderCalendarExport(ICalFeed):
    ...
    def title(self, obj):
        ...
        return f'{common_models.Vision_IMSSetting.get_setting("Vision_IMS_COMPANY_NAME")} {ordertype_title}'
