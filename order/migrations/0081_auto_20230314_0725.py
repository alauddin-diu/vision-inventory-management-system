    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', Vision_IMS.fields.Vision_IMSNotesField(blank=True, help_text='Order notes', max_length=50000, null=True, verbose_name='Notes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attachment', models.FileField(blank=True, help_text='Select file to attach', null=True, upload_to=Vision_IMS.models.rename_attachment, verbose_name='Attachment')),
                ('link', Vision_IMS.fields.Vision_IMSURLField(blank=True, help_text='Link to external URL', null=True, verbose_name='Link')),
