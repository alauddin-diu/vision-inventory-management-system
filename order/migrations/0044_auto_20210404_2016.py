...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='attachment',
            field=models.FileField(help_text='Select file to attach', upload_to=Vision_IMS.models.rename_attachment, verbose_name='Attachment'),
        ),
        migrations.AlterField(
            model_name='purchaseorderattachment',
            name='comment',
        ...
        migrations.AlterField(
            model_name='purchaseorderlineitem',
            name='quantity',
            field=Vision_IMS.fields.RoundingDecimalField(decimal_places=5, default=1, help_text='Item quantity', max_digits=15, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Quantity'),
        ),
        migrations.AlterField(
            model_name='purchaseorderlineitem',
            name='received',
        ...
        migrations.AlterField(
            model_name='salesorderallocation',
            name='quantity',
            field=Vision_IMS.fields.RoundingDecimalField(decimal_places=5, default=1, help_text='Enter stock allocation quantity', max_digits=15, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Quantity'),
        ),
        migrations.AlterField(
