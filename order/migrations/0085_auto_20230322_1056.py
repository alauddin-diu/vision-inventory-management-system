...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='total_price',
            field=Vision_IMS.fields.Vision_IMSModelMoneyField(blank=True, currency_choices=[], decimal_places=6, default_currency='', help_text='Total price for this order', max_digits=19, null=True, validators=[djmoney.models.validators.MinMoneyValidator(0)], verbose_name='Total Price'),
        ),
        migrations.AddField(
            model_name='returnorder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', Vision_IMS.fields.RoundingDecimalField(decimal_places=5, default=1, help_text='Item quantity', max_digits=15, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Quantity')),
                ...
                ('price', Vision_IMS.fields.Vision_IMSModelMoneyField(blank=True, currency_choices=[], decimal_places=6, default_currency='', help_text='Cost associated with return or repair for this line item', max_digits=19, null=True, validators=[djmoney.models.validators.MinMoneyValidator(0)], verbose_name='Price')),
                ('link', Vision_IMS.fields.Vision_IMSURLField(blank=True, help_text='Link to external page', verbose_name='Link')),
