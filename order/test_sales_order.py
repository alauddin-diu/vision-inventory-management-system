...
import order.tasks
from common.models import Vision_IMSSetting, NotificationMessage
...
class SalesOrderTest(TestCase):
    ...
    def test_default_shipment(self):
        ...
        self.assertEqual(False, Vision_IMSSetting.get_setting('SALESORDER_DEFAULT_SHIPMENT'))
        ...
        Vision_IMSSetting.set_setting('SALESORDER_DEFAULT_SHIPMENT', True, None)
        self.assertEqual(True, Vision_IMSSetting.get_setting('SALESORDER_DEFAULT_SHIPMENT'))
