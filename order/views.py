...
from Vision_IMS.helpers import DownloadFile
from Vision_IMS.views import AjaxView, Vision_IMSRoleMixin
...
class PurchaseOrderIndex(Vision_IMSRoleMixin, ListView):
...
class SalesOrderIndex(Vision_IMSRoleMixin, ListView):
...
class ReturnOrderIndex(Vision_IMSRoleMixin, ListView):
...
class PurchaseOrderDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
...
class SalesOrderDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
...
class ReturnOrderDetail(Vision_IMSRoleMixin, Vision_IMSPluginViewMixin, DetailView):
