...
from Vision_IMS.status_codes import (PurchaseOrderStatus, ReturnOrderLineStatus,
...
class OrderTest(Vision_IMSAPITestCase):
...
class PurchaseOrderDownloadTest(OrderTest):
    ...
    def test_download_csv(self):
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Vision_IMS_PurchaseOrders.csv',
        ) as file:
    ...
    def test_download_line_items(self):
        ...
        with self.download_file(
            ...
            decode=False,
            expected_code=200,
            expected_fn='Vision_IMS_PurchaseOrderItems.xlsx',
        ) as file:
    ...
    def test_export(self):
        ...
        for fmt in ['csv', 'xls', 'xlsx']:
            self.download_file(
                ...
                expected_code=200,
                expected_fn=f"Vision_IMS_SalesOrders.{fmt}"
            )
...
class SalesOrderDownloadTest(OrderTest):
    ...
    def test_download_xls(self):
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Vision_IMS_SalesOrders.xls',
            decode=False,
        ) as file:
            self.assertTrue(isinstance(file, io.BytesIO))
    ...
    def test_download_csv(self):
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Vision_IMS_SalesOrders.csv',
            decode=True
        ) as file:
        ...
        with self.download_file(
            ...
            expected_code=200,
            expected_fn='Vision_IMS_SalesOrders.tsv',
            decode=True,
        ) as file:
...
class ReturnOrderTests(Vision_IMSAPITestCase):
...
class OrderMetadataAPITest(Vision_IMSAPITestCase):
